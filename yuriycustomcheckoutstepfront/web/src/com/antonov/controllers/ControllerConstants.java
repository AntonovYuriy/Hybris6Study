 ...
 */
package com.antonov.controllers;
...
public interface ControllerConstants {
	...
	interface Actions {
		...
		interface Cms // NOSONAR
		{
			 ...
			 */
			String PurchasedCategorySuggestionComponent =
			...
			String SimpleResponsiveBannerComponent =
					_Prefix + SimpleResponsiveBannerComponentModel._TYPECODE + _Suffix; // NOSONAR
	...
	interface Views {
		...
		interface Pages {
			...
			interface MultiStepCheckout // NOSONAR
			{
				...
				String CustomMethodReactionPage = "pages/checkout/multi/customMethodReactionPage"; // NOSONAR
